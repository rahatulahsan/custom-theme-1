...
while(have_posts(  )) {
    ...
    <div class="container container--narrow page-section">
        ...
        // Custom Query to get the Professors.
        $relatedProfessors = new WP_Query(array(
            ...
            'meta_query' => array(
                ...
                'compare' => 'LIKE',
                'value' => '"'. get_the_ID() . '"' //data serialize
                )
            )
        ));
        ...
        wp_reset_postdata(); // important when need to runs multiple query in the same page

        
        // Custom Query to get the latest 2 Events and order by upcoming Date and related to that specific program
        $today = date('Ymd');
